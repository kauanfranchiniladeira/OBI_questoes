...
a forma com que resolvi esse exercício foi a seguinte, façamos um set<int>album, e para cada número de figurinha que iteramos, adicionemos elas no set, como a estrutura do set não suporta elementos repetidos, teremos apenas figurinhas distintas no set,
